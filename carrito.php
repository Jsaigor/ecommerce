...
<div class="container mt-5">
    ...
    <form method="POST" class="row g-3" action="venta.php">
        ...
        <div class="col-md-12"><textarea name="consulta" class="form-control" placeholder="Consulta"></textarea></div>
...
<div class="modal fade" id="resumenModal" tabindex="-1" aria-labelledby="resumenModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        $resumenHTML = "<ul>";
        foreach ($_SESSION['carrito'] as $item) {
        $resumenHTML .= "<li>{$prod['nombre']} x{$item['cantidad']}</li>";
        }
        $resumenHTML .= "</ul>";
        $resumenHTML .= "<p><strong>Total: $" . number_format($total, 2) . "</strong></p>";
