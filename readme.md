...
Cuando se realiza una venta o alguien se suscribe se guardan los datos en la tabla "usuarios" y se envía a "Formspree" los datos ya sea a la "action" Ecommerce ó Suscripción según corresponda (hay 2 cuentas creadas para tal fin)

PHP permite utilizar funciones en diferentes archivos, en este caso utilicé un "menu.php", "footer.php", "mostrar_productos.php", "get_categoria.php", "get_subcategoria.php", "get_items" para llamar desde cualquier página, esto ayuda si es necesario realizar algún cambio hacerlo solo en uno de ellos e impacta en todas las páginas que llamen a estas funciones
...
La parte de "Reseñas" llama a una API de randomuser.me y trae de a 5 "usuarios" ficticios para mostrar en un carrousel
